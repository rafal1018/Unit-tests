...
public class AddresTest {
    ...
    void givenAdrressesShouldNotBeEmptyAndHaveProperNames(String street, String number) {
    ...
    void addresseFromFileShouldNotBeEmptyAndHaveProperNames(String street, String number) {
        assertThat(street, notNullValue());
        assertThat(street, containsString("a"));
        assertThat(number, notNullValue());
        assertThat(number.length(), lessThan(8));
